...
fileDuplo5 = 4.9 
fileDuploMaisde5 = 5.8
alcatra5 = 5.9
alcatraMaisde5 = 6.8
picanha5 = 6.9
picanhaMaisde5 = 7.8

qdeCarne = fileDuplo5 + fileDuploMaisde5 + alcatra5 + alcatraMaisde5 + picanha5 + picanhaMaisde5

tipoDeCarne = str(input('Digite o tipo de carne que vai comprar: {A - Alcatra, F - File ou P - Picanha}: '))
qdekg = float(input('Digite quantos kg você quer: '))'''
